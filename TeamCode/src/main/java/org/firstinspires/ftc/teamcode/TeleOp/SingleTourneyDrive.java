...
public class SingleTourneyDrive extends LinearOpMode {
    @Override
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            boolean armPos1 = gamepad1.dpad_right;
            boolean armPos2 = gamepad1.dpad_up;
            boolean armPos3 = gamepad1.dpad_left;
            boolean armPos4 = gamepad1.dpad_down;
